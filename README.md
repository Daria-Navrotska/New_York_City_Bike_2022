...
The dashboard developed from this analysis expected to support the business strategy department in diagnosing **bike availability issues** and guiding **data-driven decisions** to ensure a balanced and efficient service network.
...
The insights derived used for **interactive strategic dashboard**, designed to communicate results clearly to non-technical stakeholders and help guide future station expansion.
...
- **Programming Language:** Python (v3.13)  
